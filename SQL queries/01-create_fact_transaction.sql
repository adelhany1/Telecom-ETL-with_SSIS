...
GO
*/
-- Need to adapt the columns tac,snr to null to load the data first before the transformation
-- this is not the only way we can redirect the rows instead of fail the component option in ssis
